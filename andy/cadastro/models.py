...
class Member(models.Model):
    ...
    rg = models.CharField(u'Documento de identidade', max_length=15)
    id_type = models.CharField(u"Tipo do documento", choices=(("RG", "RG"), ("RNE", "RNE")), max_length=4)
...
class BikeUsageSurvey(models.Model):
    ...
    city_region = MultiSelectField("Por onde você pedala (SUBPREFEITURAS / distritos)", choices=CITY_REGION, default="", blank=True)
