...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.birth'
        db.alter_column('cadastro_member', 'birth', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Member.birth'
        db.alter_column('cadastro_member', 'birth', self.gf('django.db.models.fields.DateField')(default='1960-01-01'))
