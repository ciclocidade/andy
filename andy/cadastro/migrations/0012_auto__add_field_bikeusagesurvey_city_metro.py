...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BikeUsageSurvey.city_metro'
        db.add_column('cadastro_bikeusagesurvey', 'city_metro', self.gf('cadastro.multiselectmodelfield.MultiSelectField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BikeUsageSurvey.city_metro'
        db.delete_column('cadastro_bikeusagesurvey', 'city_metro')
    ...
    models = {
        ...
        'cadastro.bikeusagesurvey': {
            ...
            'city_metro': ('cadastro.multiselectmodelfield.MultiSelectField', [], {'default': "''"}),
            'city_region': ('cadastro.multiselectmodelfield.MultiSelectField', [], {'default': "''"}),
