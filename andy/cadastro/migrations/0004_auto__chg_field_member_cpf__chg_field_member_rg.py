...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cadastro_member', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Member.rg'
        db.alter_column('cadastro_member', 'rg', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'Member.cpf'
        db.alter_column('cadastro_member', 'cpf', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Member.rg'
        db.alter_column('cadastro_member', 'rg', self.gf('django.db.models.fields.IntegerField')())
