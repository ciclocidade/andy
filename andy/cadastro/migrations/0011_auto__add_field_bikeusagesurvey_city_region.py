...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BikeUsageSurvey.city_region'
        db.add_column('cadastro_bikeusagesurvey', 'city_region', self.gf('cadastro.multiselectmodelfield.MultiSelectField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BikeUsageSurvey.city_region'
        db.delete_column('cadastro_bikeusagesurvey', 'city_region')
