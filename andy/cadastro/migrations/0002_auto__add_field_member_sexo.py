...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.sexo'
        db.add_column('cadastro_member', 'sexo', self.gf('django.db.models.fields.CharField')(default='F', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.sexo'
        db.delete_column('cadastro_member', 'sexo')
