...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.address_zip'
        db.alter_column('cadastro_member', 'address_zip', self.gf('django.db.models.fields.CharField')(max_length=9))


    def backwards(self, orm):
        
        # Changing field 'Member.address_zip'
        db.alter_column('cadastro_member', 'address_zip', self.gf('django.db.models.fields.IntegerField')(max_length=9))
