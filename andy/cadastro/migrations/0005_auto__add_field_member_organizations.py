...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Member.organizations'
        db.add_column('cadastro_member', 'organizations', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.organizations'
        db.delete_column('cadastro_member', 'organizations')
    ...
    models = {
        ...
        'cadastro.member': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organizations': ('django.db.models.fields.TextField', [], {'default': "''"}),
