...
admin.site.register(Member, list_display=('name', 'email', 'created_at', 'birth', 'city_uf_str', 'cpf', 'education'), list_filter=('created_at', 'sexo', 'birth', 'address_state', 'education', 'receive_news'), search_fields=('user__first_name', 'user__last_name', 'user__email', 'cpf'))
